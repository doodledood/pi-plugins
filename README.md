...
Do not rely on undocumented Git subdirectory install syntax. The examples use the pinned `@v0.1.0` release tag. Use `@main` only when you intentionally want the latest development version.
