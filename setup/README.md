...
8. If a previous machine used `models.json` or `model-aliases.json` to carry old 1M-context model overrides, remove those entries before copying the current empty alias template.
